...
oracle_out=$(cast create2 -i $oracle_initcode -d $create2 --starts-with "00" | grep -E '(Address:|Salt:)')
...
relayer_out=$(cast create2 -i $relayer_initcode -d $create2 --starts-with "00" | grep -E '(Address:|Salt:)')
